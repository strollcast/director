...
**Hosts:** Alex Chen (AI researcher) & Maya Rodriguez (ML engineer)
...
**ALEX:** Welcome back to "Gradient Descent," the podcast where we break down the papers that shaped modern machine learning. I'm Alex Chen.

**MAYA:** And I'm Maya Rodriguez. Today we're tackling one of the most influential systems papers in deep learning—one that literally made training models with hundreds of billions of parameters possible.

**ALEX:** That's right. We're talking about ZeRO: Memory Optimizations Toward Training Trillion Parameter Models, published by Samyam Rajbhandari, Jeff Rasley, Olatunji Ruwase, and Yuxiong He from Microsoft Research.

**MAYA:** This paper came out in late 2019, and Alex, I remember exactly where I was when I first read it. I was trying to train a relatively modest transformer model, maybe 500 million parameters, and I kept running out of memory. I was so frustrated.

**ALEX:** And that frustration was universal. Everyone in the field was hitting the same wall.
...
**ALEX:** Let's set the stage for our listeners who might not remember 2019 in the AI world. GPT-2 had just come out with 1.5 billion parameters, and it was causing a huge stir. OpenAI initially didn't even release the full model because they were worried about misuse.
...
**ALEX:** And here's the thing that I think surprises a lot of people even today: the model parameters themselves aren't even the main memory hog during training. There's this whole hidden iceberg of memory consumption that most people don't think about.
...
**ALEX:** Okay, so let's break this down from first principles. When you're training a neural network, what's actually living in GPU memory?
...
**ALEX:** But that's just the tip of the iceberg.
...
**ALEX:** We're already at 6 gigabytes.
...
**ALEX:** Can you explain what those are for listeners who might not be familiar?
...
**ALEX:** So that's two additional values per parameter.
...
**ALEX:** So we have 4 bytes per parameter for momentum, 4 bytes for variance...
...
**ALEX:** Let me add this up. For a 1.5 billion parameter model: 3 gigs for fp16 parameters, 3 gigs for fp16 gradients, and 12 bytes times 1.5 billion is... 18 gigabytes just for optimizer states.
...
**ALEX:** Ah yes, the activations. This is what catches a lot of people off guard.
...
**ALEX:** How much memory do activations use?
...
**ALEX:** So we're looking at potentially 50, 60, 70 gigabytes for a model that only has 3 gigabytes of actual weights.
...
**ALEX:** The paper has this great analysis where they categorize memory into model states versus residual states—the activations, temporary buffers, and fragmentation. And they show that for GPT-2 scale models, it's actually the model states that dominate.
...
**ALEX:** So before ZeRO came along, how were people dealing with this memory problem?
...
**ALEX:** Let's start with data parallelism since it's the more common one.
...
**ALEX:** So if you have 8 GPUs and a batch size of 64...
...
**ALEX:** The averaging step is the key communication operation, right?
...
**ALEX:** So what's the problem with data parallelism?
...
**ALEX:** So you're not solving the memory problem at all.
...
**ALEX:** What about model parallelism?
...
**ALEX:** There are techniques to reduce the bubbles though, right?
...
**ALEX:** That sounds like it would require a lot of communication.
...
**ALEX:** So tensor parallelism might let you split across 8 GPUs in a node...

**MAYA:** But not across 64 GPUs spanning 8 nodes. You hit a scaling wall.

**ALEX:** And both forms of model parallelism require significant code changes, right?
...
**ALEX:** Which brings us to ZeRO and its key insight.
...
**ALEX:** That's a really elegant reframing of the problem.
...
**ALEX:** Right, they all do the same update, which is why they stay synchronized.
...
**ALEX:** And then you'd need to share the updated parameters...
...
**ALEX:** Wait, really? The same communication cost?
...
**ALEX:** But now each GPU only stores a fraction of the optimizer states.
...
**ALEX:** But they didn't stop at optimizer states.
...
**ALEX:** So you're saving another chunk of memory.
...
**ALEX:** But wait—you need all the parameters to actually compute the forward and backward passes.
...
**ALEX:** So you're constantly gathering and discarding?
...
**ALEX:** I think it would help our listeners to really understand the communication operations here. Can you explain all-reduce, reduce-scatter, and all-gather?

**MAYA:** Absolutely. These are the bread and butter of distributed computing, so let's break them down.

**ALEX:** Start with all-reduce.
...
**ALEX:** So everyone contributes, everyone gets the result.
...
**ALEX:** So the result is distributed.
...
**ALEX:** So reduce-scatter followed by all-gather equals all-reduce.
...
**ALEX:** And modern communication libraries are really good at implementing these efficiently.
...
**ALEX:** The paper mentions overlapping communication with computation. How does that work?
...
**ALEX:** So you're pipelining the gathering with the computation.
...
**ALEX:** Let's get into the quantitative analysis. The paper has some nice formulas for memory consumption.
...
**ALEX:** So that's 16Ψ total bytes.
...
**ALEX:** Which means you have tons of memory left for activations.
...
**ALEX:** There's also analysis of when each stage is most beneficial, right?
...
**ALEX:** Let's talk about the practical implementation. The paper introduces ZeRO as part of Microsoft's DeepSpeed library.
...
**ALEX:** What does it look like to use in practice?
...
**ALEX:** No changes to the model code?
...
**ALEX:** The paper also mentions several optimizations. Gradient bucketing, communication overlap...
...
**ALEX:** And there's also CPU offloading mentioned.
...
**ALEX:** Let's talk results. What did the experiments show?
...
**ALEX:** How does the performance compare to baselines?
...
**ALEX:** Because the communication pattern is equivalent.
...
**ALEX:** They also compared against model parallelism, right?
...
**ALEX:** And the combination works too.
...
**ALEX:** We're several years out from this paper now. What's the impact been?
...
**ALEX:** And there's been a lot of follow-up work.
...
**ALEX:** What about PyTorch's FSDP?
...
**ALEX:** Has the idea influenced other frameworks?
...
**ALEX:** What made this paper so influential, in your view?
...
**ALEX:** Any limitations we should mention?
...
**ALEX:** And network bandwidth matters.
...
**ALEX:** Well, we've covered a lot of ground. Any final thoughts?
...
**ALEX:** It's also a reminder that systems papers matter. You can have the best algorithms in the world, but if you can't run them at scale, they stay theoretical. ZeRO made the theory practical.
...
**ALEX:** That's going to do it for today's episode of Gradient Descent. Thanks for listening, everyone.

**MAYA:** If you enjoyed this deep dive, please subscribe, leave a review, and let us know what papers you want us to cover next. You can find us on Twitter at gradient underscore pod.

**ALEX:** Until next time, keep training.

**MAYA:** And may your gradients never explode.

**[Outro music fades in]**

**ALEX:** That's still a terrible sign-off.
